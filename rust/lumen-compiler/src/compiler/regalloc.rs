...
impl RegAlloc {
    ...
    /// Returns u16 to feed directly into LirCell.registers.
    ...
    pub fn free_statement_temps(&mut self) {
        ...
        let named_regs: Vec<u16> = self.bindings.values().copied().collect();
