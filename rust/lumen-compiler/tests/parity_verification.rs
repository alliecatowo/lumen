...
#[test]
fn parity_verification_build_succeeds() {
    let cl = checklist();
    assert!(!cl.is_empty());
}

#[test]
fn parity_verification_at_least_35_items() {
    let cl = checklist();
    assert!(cl.len() >= 35, "expected >= 35 items, got {}", cl.len());
}

#[test]
fn parity_verification_exactly_42_items() {
    let cl = checklist();
    assert_eq!(cl.len(), 42, "expected 42 items, got {}", cl.len());
}

#[test]
fn parity_verification_validation_passes() {
    let cl = checklist();
...
#[test]
fn parity_verification_default_equals_build() {
...
#[test]
fn parity_verification_all_ids_start_with_vp() {
    let cl = checklist();
...
#[test]
fn parity_verification_all_ids_unique() {
    let cl = checklist();
...
#[test]
fn parity_verification_ids_sequential() {
    let cl = checklist();
...
#[test]
fn parity_verification_no_empty_features() {
    let cl = checklist();
    for item in &cl.items {
...
#[test]
fn parity_verification_no_empty_descriptions() {
    let cl = checklist();
    for item in &cl.items {
        assert!(
...
#[test]
fn parity_verification_no_empty_comparable_to() {
    let cl = checklist();
    for item in &cl.items {
        assert!(
...
#[test]
fn parity_verification_no_empty_lumen_approach() {
    let cl = checklist();
    for item in &cl.items {
        assert!(
...
#[test]
fn parity_verification_all_18_categories_covered() {
    let cl = checklist();
...
#[test]
fn parity_verification_type_safety_items() {
    let cl = checklist();
...
#[test]
fn parity_verification_refinement_types_items() {
    let cl = checklist();
...
#[test]
fn parity_verification_effect_tracking_items() {
    let cl = checklist();
...
#[test]
fn parity_verification_smt_integration_items() {
    let cl = checklist();
...
#[test]
fn parity_verification_dependent_types_item() {
    let cl = checklist();
...
#[test]
fn parity_verification_has_implemented_items() {
    let cl = checklist();
...
#[test]
fn parity_verification_has_partial_items() {
    let cl = checklist();
    let partial = cl
        .items
        .iter()
...
#[test]
fn parity_verification_has_designed_items() {
    let cl = checklist();
    let designed = cl
        .items
        .iter()
...
#[test]
fn parity_verification_has_not_applicable_items() {
    let cl = checklist();
...
#[test]
fn parity_verification_pending_items() {
    let cl = checklist();
...
#[test]
fn parity_verification_status_counts_sum_to_total() {
    let cl = checklist();
...
#[test]
fn parity_verification_find_by_id_vp001() {
    let cl = checklist();
...
#[test]
fn parity_verification_find_by_id_vp042() {
    let cl = checklist();
...
#[test]
fn parity_verification_find_by_id_missing() {
    let cl = checklist();
    assert!(cl.find_by_id("VP-999").is_none());
}

#[test]
fn parity_verification_find_by_id_empty() {
    let cl = checklist();
...
#[test]
fn parity_verification_vp008_is_not_applicable() {
    let cl = checklist();
...
#[test]
fn parity_verification_vp020_is_implemented() {
    let cl = checklist();
...
#[test]
fn parity_verification_vp031_z3_backend() {
    let cl = checklist();
...
#[test]
fn parity_verification_vp013_postcondition_designed() {
    let cl = checklist();
...
#[test]
fn parity_verification_vp027_model_checking_partial() {
    let cl = checklist();
...
#[test]
fn parity_verification_summary_total() {
    let cl = checklist();
    let summary = cl.summary();
...
#[test]
fn parity_verification_summary_category_count() {
    let cl = checklist();
    let summary = cl.summary();
    assert_eq!(
...
#[test]
fn parity_verification_summary_has_comparable_systems() {
    let cl = checklist();
    let summary = cl.summary();
    assert!(
...
#[test]
fn parity_verification_summary_display() {
    let cl = checklist();
    let summary = cl.summary();
...
#[test]
fn parity_verification_category_display() {
    assert_eq!(
...
#[test]
fn parity_verification_status_display_implemented() {
    assert_eq!(format!("{}", VerifParityStatus::Implemented), "Implemented");
}

#[test]
fn parity_verification_status_display_partial() {
...
#[test]
fn parity_verification_status_display_designed() {
    assert_eq!(format!("{}", VerifParityStatus::Designed), "Designed");
}

#[test]
fn parity_verification_status_display_not_applicable() {
...
#[test]
fn parity_verification_item_display() {
    let cl = checklist();
...
#[test]
fn parity_verification_items_by_status_implemented() {
    let cl = checklist();
...
#[test]
fn parity_verification_items_by_status_designed() {
    let cl = checklist();
