...
fn is_err_union(tag_err: u32, v: &Value) -> bool {
    matches!(v, Value::Union(u) if u.tag == tag_err)
}
...
#[test]
fn parse_int_basic() {
    let (vm, result) = run_main_with_vm(
        r#"
cell main() -> Any
  return parse_int("42")
end
"#,
    ...
    assert_eq!(result, ok_int(vm.tag_ok, 42));
}
...
"#,
    ...
    assert_eq!(result, ok_int(vm.tag_ok, -17));
}
...
"#,
    ...
    assert_eq!(result, ok_int(vm.tag_ok, 0));
}
...
"#,
    ...
    assert_eq!(result, ok_int(vm.tag_ok, 123));
}
...
"#,
    ...
    assert!(
        is_err_union(vm.tag_err, &result),
...
"#,
    ...
    assert!(
        is_err_union(vm.tag_err, &result) || result == ok_int(vm.tag_ok, 3),
...
"#,
    ...
    assert_eq!(result, ok_int(vm.tag_ok, i64::MAX));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, 3.14));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, 42.0));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, -2.5));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, 1.5));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, 150.0));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, 2.718));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, 7.0));
}
...
"#,
    ...
    assert_eq!(result, ok_float(vm.tag_ok, 0.0));
}
...
"#,
    ...
    assert_eq!(result, ok_int(vm.tag_ok, 10));
}
