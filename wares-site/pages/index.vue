  ...
  <div>
    ...
    <section class="py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-else-if="featuredWarez.length" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <WareCard v-for="ware in featuredWarez" :key="ware.name" :ware="ware" />
        </div>
